 ...
 for i = 1:10000   
    ...
    if length(commas)>1
        ...
        if mod(i, 2) == 0
            ...
            % mean
            accel_6(:, :, 1) = (accel_1(:, :, 1) + accel_2(:, :, 1)...
                + accel_3(:, :, 1) + accel_4(:, :, 1) + accel_5(:, :, 1))/5;
            accel_6(:, :, 2) = (accel_1(:, :, 2) + accel_2(:, :, 2)...
                + accel_3(:, :, 2) + accel_4(:, :, 2) + accel_5(:, :, 2))/5;
            accel_6(:, :, 3) = (accel_1(:, :, 3) + accel_2(:, :, 3)...
                + accel_3(:, :, 3) + accel_4(:, :, 3) + accel_5(:, :, 3))/5;
            ...
            %title("d");xlabel('Time (s)');ylabel('Frequency (Hz)')
