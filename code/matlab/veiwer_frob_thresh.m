...
%while(1)
 for i = 1:10000   
    ...
    if length(commas)>1
        ...
        if mod(i, 2) == 0
%             plot_accel1.YData = accel1;
%             plot_accel2.YData = accel2;
%             plot_accel3.YData = accel3;
%             plot_accel4.YData = accel4;
%             plot_accel5.YData = accel5;
            plot_accel1(1).YData = accel1(:, 1);
            plot_accel1(2).YData = accel1(:, 2);
            plot_accel1(3).YData = accel1(:, 3);
            plot_accel2(1).YData = accel2(:, 1);
            plot_accel2(2).YData = accel2(:, 2);
            plot_accel2(3).YData = accel2(:, 3);
            plot_accel3(1).YData = accel3(:, 1);
            plot_accel3(2).YData = accel3(:, 2);
            plot_accel3(3).YData = accel3(:, 3);
            plot_accel4(1).YData = accel4(:, 1);
            plot_accel4(2).YData = accel4(:, 2);
            plot_accel4(3).YData = accel4(:, 3);
            plot_accel5(1).YData = accel5(:, 1);
            plot_accel5(2).YData = accel5(:, 2);
            plot_accel5(3).YData = accel5(:, 3);
            plot_accel6(1).YData = accel6(:, 1);
            plot_accel6(2).YData = accel6(:, 2);
            plot_accel6(3).YData = accel6(:, 3);
            ...
            [fr_11, fr_12, fr_13] = norm_channel_thresh(accel_1, 120);
            [fr_21, fr_22, fr_23] = norm_channel_thresh(accel_2, 120);
            [fr_31, fr_32, fr_33] = norm_channel_thresh(accel_3, 120);
            [fr_41, fr_42, fr_43] = norm_channel_thresh(accel_4, 120);
            [fr_51, fr_52, fr_53] = norm_channel_thresh(accel_5, 120);
